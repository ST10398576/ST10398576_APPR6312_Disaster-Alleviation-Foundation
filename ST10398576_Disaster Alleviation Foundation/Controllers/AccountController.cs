...
namespace ST10398576_Disaster_Alleviation_Foundation.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(ViewModels.RegisterViewModel vm)
        {
            ...
            return RedirectToAction("https://disasteralleviationfoundation-bteeanhagaf3bsgm.spaincentral-01.azurewebsites.net/Account/Login");
        }
        ...
        public async Task<IActionResult> Login(ViewModels.LoginViewModel vm)
        {
            ...
            if (result.Succeeded) return RedirectToAction("https://disasteralleviationfoundation-bteeanhagaf3bsgm.spaincentral-01.azurewebsites.net/Home/Index");
